...
project_name = 'test-project1-335020'
zone_name = 'test-project1'
...
#os.environ['GOOGLE_APPLICATION_CREDENTIALS'] = '.\key.json' #Only required on hosts outside of Compute Engine environment.
